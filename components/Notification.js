...
function Notification({message}) {
    return (
        <div className="top-0 flex sticky w-screen lg:-ml-44 -ml-4 bg-notification-bg z-30 py-3 md:px-12 lg:px-40 px-4 overflow-hidden opacity-1 -translate-y-20" id="filterNotification">
