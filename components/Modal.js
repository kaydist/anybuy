...
function Modal({ref, state, close, children}) {
    ...
    const showClass = state === true ? "fixed top-0 left-0 w-screen h-screen bg-[#00000060] modal z-50 opacity-1 transition-opacity" : "fixed top-0 left-0 w-screen h-screen bg-[#00000060] modal -z-50 opacity-0 transition-opacity"
