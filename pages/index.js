  ...
  const categories = [
    {
      ...
      title: "Gaming",
      thumbnail:
        "https://res.cloudinary.com/kaydist/image/upload/v1646751499/Anybuy/categories/Ellipse_2_tiutud.png",
    },
    {
      id: 2,
      name: "Speakers",
      title: "Speakers",
      thumbnail:
        "https://res.cloudinary.com/kaydist/image/upload/v1646751499/Anybuy/categories/Ellipse_3_ojmeqr.png",
    },
    {
      id: 3,
      name: "Phones",
      title: "Phones",
      thumbnail:
        "https://res.cloudinary.com/kaydist/image/upload/v1646751498/Anybuy/categories/Ellipse_5_h3zwkr.png",
    },
    {
      id: 4,
      name: "Laptops",
      title: "Laptops",
      thumbnail:
        "https://res.cloudinary.com/kaydist/image/upload/v1646751498/Anybuy/categories/Ellipse_6_ylxo7f.png",
    },
    {
      id: 6,
      name: "VR",
      title: "VR",
      thumbnail:
        "https://res.cloudinary.com/kaydist/image/upload/v1646751499/Anybuy/categories/Ellipse_7_calli1.png",
    },
  ];
      ...
      <section className="relative overflow-visible">
        <div className="flex justify-center flex-col items-center z-10 relative">
          <div className="flex justify-center flex-col items-start lg:items-center w-full px-4 text-white font-black mt-20">
            <h1 className="lg:text-4xl text-2xl">Buy the best Products</h1>
            <h1 className="lg:text-4xl text-2xl">at Affordable Prices</h1>
          ...
          <div className="w-full overflow-hidden">
            <h3 className="font-extrabold text-xl text-white mb-4 w-full text-center">
              Recommeded for you
            </h3>
            <div className="flex flex-row lg:justify-center py-2 pr-8 lg:px-0 items-center gap-8 overflow-x-auto overflow-y-hidden w-screen md:w-full flex-nowrap">
              {Recommendation.filter((product, idx) => idx < 3).map(
                (product) => {
      ...
      <section className="mt-20 overflow-hidden">
        ...
        <div className="flex flex-row gap-8 py-2">
          <Link href="/recharge" passHref>
            <a>
              <div className="card gap-2 flex flex-col items-center justify-center hover:shadow-md hover:transition-shadow">
