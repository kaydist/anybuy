...
const stripePromise = loadStripe(
  "pk_test_51KiackC2Sb7pUw98SzfBW6ls6QpeKiDzdTncO2s4gp1pJ9IRhlVMbG8AhdeXVBtLeAI3xps4XxzucH7pN2OGkfKk00YKaBDPmk"
);
              ...
              <div className="w-full card" id="1" data-accordion="01">
                ...
                <div className="h-fit opacity-1 mt-8 content" id="content-1">
                  {currentUser?.shippingInfo !== null ? (
                    <span>
                      <p>
                        {currentUser?.shippingInfo?.firstName}{" "}
                        {currentUser?.shippingInfo?.lastName}
                      </p>
